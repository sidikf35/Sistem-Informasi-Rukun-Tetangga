<?php
// =====================================================
// FILE: views/warga/edit.php
// FUNGSI: Form edit warga
// =====================================================
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    <aside class="sidebar">
        <div class="sidebar-header">
            <div class="logo-icon"><i class="fas fa-user-edit"></i></div>
    ...
    <main class="main-content">
        <div class="top-bar">
            <div class="page-title">
                <h1><i class="fas fa-user-edit"></i> Edit Warga</h1>
                <p>Ubah data warga yang sudah terdaftar</p>
            </div>
            <div class="user-menu">
                <div class="user-info">
        ...
        <div class="form-container">
            <h2><i class="fas fa-edit"></i> Edit Data Warga</h2>
            ...
            <form method="POST" action="index.php?action=warga-update">
                <input type="hidden" name="id" value="<?= $warga['id'] ?>">

                <div class="form-row">
                    <div class="form-group">
                        <label>NIK <span class="required">*</span></label>
                        <input type="text" name="nik" maxlength="16" value="<?= htmlspecialchars($warga['nik']) ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label>No KK <span class="required">*</span></label>
                        <input type="text" name="no_kk" value="<?= htmlspecialchars($warga['no_kk']) ?>" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" value="<?= htmlspecialchars($warga['nama_lengkap']) ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label>Tempat Lahir <span class="required">*</span></label>
                        <input type="text" name="tempat_lahir" value="<?= htmlspecialchars($warga['tempat_lahir']) ?>"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" rows="3" required><?= htmlspecialchars($warga['alamat']) ?></textarea>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label>RT</label>
                        <input type="text" name="rt" value="<?= htmlspecialchars($warga['rt']) ?>">
                    </div>
                    <div class="form-group">
                        <label>RW</label>
                        <input type="text" name="rw" value="<?= htmlspecialchars($warga['rw']) ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="status">
                            ...
                            <option value="meninggal" <?= $warga['status'] == 'meninggal' ? 'selected' : '' ?>>Meninggal
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-update"><i class="fas fa-save"></i> Update Data</button>
